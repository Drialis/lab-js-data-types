...
let result1 = part1.substring(0, part1.length - 1) + part1[part1.length - 1].toUpperCase()
let result2 = part2.substring(0, part2.length - 1) + part2[part2.length - 1].toUpperCase()
